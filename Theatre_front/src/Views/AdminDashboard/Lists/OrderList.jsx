            ...
            <tbody>
              {orders.map((order) => (
                <tr key={order.orderId} className="hover:bg-gray-50 transition">
                  ...
                  type="checkbox" value={order.isApproved}/></td>
                  <td className="border px-4 py-2"><input
                  type="checkbox" value={order.isPaid}/></td>
                  <td className="border px-4 py-2">{format(new Date(order.startDate), 'dd-MM-yyyy')}</td>
                  <td className="border px-4 py-2">{format(new Date(order.endDate), 'dd-MM-yyyy')}</td>
